 ...
 *           
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;attribute xmlns="http://www.w3.org/2001/XMLSchema" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="provisional-distance-between-starts" type="fo:provisional_distance_between_starts_Type"/&gt;
 * </pre>
 * 
 *           
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;attribute xmlns="http://www.w3.org/2001/XMLSchema" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="provisional-label-separation" type="fo:provisional_label_separation_Type"/&gt;
 * </pre>
 * 
 *         
 * 
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.w3.org/1999/XSL/Format}list-item" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "list-block")
public class ListBlock {
    ...
    @XmlAttribute(name = "background-position")
    protected List<String> backgroundPosition;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the backgroundPosition property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<String> getBackgroundPosition() {
        if (backgroundPosition == null) {
            backgroundPosition = new ArrayList<String>();
        }
    ...
    public ListItem withListItem(int index) {
        List<ListItem> list = this.getListItem();
        if (list.size()<= index) {
            for (int i = list.size(); (i<= index); i ++) {
                list.add(null);
            }
        }
        ListItem value = list.get(index);
        if (value == null) {
            value = new ListItem();
    ...
    public ListItem withNewListItem() {
        ListItem value = new ListItem();
        this.getListItem().add(value);
        return value;
    }
