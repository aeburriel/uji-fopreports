 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.w3.org/1999/XSL/Format}multi-property-set" maxOccurs="unbounded"/>
 *         &lt;element ref="{http://www.w3.org/1999/XSL/Format}wrapper"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "multi-properties")
public class MultiProperties {

    @XmlElement(name = "multi-property-set", required = true)
    protected List<MultiPropertySet> multiPropertySet;
    ...
    /**
     * Gets the value of the multiPropertySet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the multiPropertySet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMultiPropertySet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MultiPropertySet }
     * 
     * 
     */
    public List<MultiPropertySet> getMultiPropertySet() {
        if (multiPropertySet == null) {
            multiPropertySet = new ArrayList<MultiPropertySet>();
        }
        return this.multiPropertySet;
    }
    ...
    public MultiPropertySet withMultiPropertySet(int index) {
        List<MultiPropertySet> list = this.getMultiPropertySet();
        if (list.size()<= index) {
            for (int i = list.size(); (i<= index); i ++) {
                list.add(null);
            }
        }
        MultiPropertySet value = list.get(index);
        if (value == null) {
            value = new MultiPropertySet();
            list.set(index, value);
        }
        return value;
    }

    public MultiPropertySet withNewMultiPropertySet() {
        MultiPropertySet value = new MultiPropertySet();
        this.getMultiPropertySet().add(value);
        return value;
    }

    public Wrapper withWrapper() {
