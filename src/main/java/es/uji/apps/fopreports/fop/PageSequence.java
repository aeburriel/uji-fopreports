 ...
 *           
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;attribute xmlns="http://www.w3.org/2001/XMLSchema" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="country" type="fo:country_Type"/&gt;
 * </pre>
 *  
 *           
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;attribute xmlns="http://www.w3.org/2001/XMLSchema" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="language" type="fo:language_Type"/&gt;
 * </pre>
 * 
 *         
 * 
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.w3.org/1999/XSL/Format}title" minOccurs="0"/>
 *         &lt;element ref="{http://www.w3.org/1999/XSL/Format}static-content" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.w3.org/1999/XSL/Format}flow"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.w3.org/1999/XSL/Format}inheritable_properties_List"/>
 *       &lt;attribute name="id" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="master-reference" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="initial-page-number" type="{http://www.w3.org/1999/XSL/Format}integer_Type" />
 *       &lt;attribute name="force-page-count" type="{http://www.w3.org/1999/XSL/Format}force_page_count_Type" />
 *       &lt;attribute name="format" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="letter-value" type="{http://www.w3.org/1999/XSL/Format}letter_value_Type" />
 *       &lt;attribute name="grouping-separator" type="{http://www.w3.org/1999/XSL/Format}character_Type" />
 *       &lt;attribute name="grouping-size" type="{http://www.w3.org/1999/XSL/Format}integer_Type" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class PageSequence {
    ...
    protected List<StaticContent> staticContent;
    ...
    @XmlAttribute(name = "initial-page-number")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String initialPageNumber;
    @XmlAttribute(name = "force-page-count")
    protected ForcePageCountType forcePageCount;
    @XmlAttribute(name = "format")
    protected String format;
    @XmlAttribute(name = "letter-value")
    protected LetterValueType letterValue;
    ...
    /**
     * Gets the value of the staticContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the staticContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStaticContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<StaticContent> getStaticContent() {
        if (staticContent == null) {
            staticContent = new ArrayList<StaticContent>();
        }
    ...
    /**
     * Gets the value of the initialPageNumber property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the initialPageNumber property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setInitialPageNumber(String value) {
     ...
     * @return
     *     possible object is
     *     {@link ForcePageCountType }
     *     
     */
    public ForcePageCountType getForcePageCount() {
     ...
     *     
     */
    public void setForcePageCount(ForcePageCountType value) {
        this.forcePageCount = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link LetterValueType }
     *     
     */
    public LetterValueType getLetterValue() {
        return letterValue;
    }
     ...
     *     
     */
    public void setLetterValue(LetterValueType value) {
    ...
    public StaticContent withStaticContent(int index) {
        List<StaticContent> list = this.getStaticContent();
        if (list.size()<= index) {
            for (int i = list.size(); (i<= index); i ++) {
                list.add(null);
            }
        }
        StaticContent value = list.get(index);
        if (value == null) {
            value = new StaticContent();
            list.set(index, value);
        }
        return value;
    }

    public StaticContent withNewStaticContent() {
        StaticContent value = new StaticContent();
        this.getStaticContent().add(value);
        return value;
    }

    public Flow withFlow() {
        if (this.flow == null) {
            flow = new Flow();
        }
        return flow;
