...
public class ListItem {
    ...
    @XmlElement(name = "list-item-label", required = true)
    protected ListItemLabel listItemLabel;
    @XmlElement(name = "list-item-body", required = true)
    ...
    public ListItemLabel withListItemLabel() {
        if (this.listItemLabel == null) {
            listItemLabel = new ListItemLabel();
        }
        return listItemLabel;
    }

    public ListItemBody withListItemBody() {
        if (this.listItemBody == null) {
