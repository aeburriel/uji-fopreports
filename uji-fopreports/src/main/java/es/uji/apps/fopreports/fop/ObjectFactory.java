 ...
 * generated in the es.uji.apps.foreports.fop.jaxb package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.uji.apps.foreports.fop.jaxb
     * 
     */
