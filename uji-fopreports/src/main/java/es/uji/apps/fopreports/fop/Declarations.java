...
public class Declarations {
    ...
    @XmlElement(name = "color-profile", required = true)
    protected List<ColorProfile> colorProfile;
    @XmlAnyElement
     ...
     * 
     */
    public List<ColorProfile> getColorProfile() {
        if (colorProfile == null) {
            colorProfile = new ArrayList<ColorProfile>();
        }
    ...
    public ColorProfile withColorProfile(int index) {
        List<ColorProfile> list = this.getColorProfile();
        if (list.size()<= index) {
            for (int i = list.size(); (i<= index); i ++) {
                list.add(null);
            }
        }
        ColorProfile value = list.get(index);
        if (value == null) {
            value = new ColorProfile();
            list.set(index, value);
        }
        return value;
    }

    public ColorProfile withNewColorProfile() {
        ColorProfile value = new ColorProfile();
        this.getColorProfile().add(value);
        return value;
    }
