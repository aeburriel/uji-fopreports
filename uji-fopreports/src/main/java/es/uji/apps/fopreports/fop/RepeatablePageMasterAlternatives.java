 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.w3.org/1999/XSL/Format}conditional-page-master-reference" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.w3.org/1999/XSL/Format}inheritable_properties_List"/>
 *       &lt;attribute name="maximum-repeats" type="{http://www.w3.org/1999/XSL/Format}integer_Type" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlRootElement(name = "repeatable-page-master-alternatives")
public class RepeatablePageMasterAlternatives {

    @XmlElement(name = "conditional-page-master-reference", required = true)
    protected List<ConditionalPageMasterReference> conditionalPageMasterReference;
    @XmlAttribute(name = "maximum-repeats")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String maximumRepeats;
    ...
    /**
     * Gets the value of the conditionalPageMasterReference property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the conditionalPageMasterReference property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getConditionalPageMasterReference().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ConditionalPageMasterReference }
     * 
     * 
     */
    public List<ConditionalPageMasterReference> getConditionalPageMasterReference() {
        if (conditionalPageMasterReference == null) {
            conditionalPageMasterReference = new ArrayList<ConditionalPageMasterReference>();
        }
        return this.conditionalPageMasterReference;
    }

    /**
     * Gets the value of the maximumRepeats property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the maximumRepeats property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMaximumRepeats(String value) {
        this.maximumRepeats = value;
    }
    ...
    public ConditionalPageMasterReference withConditionalPageMasterReference(int index) {
        List<ConditionalPageMasterReference> list = this.getConditionalPageMasterReference();
        if (list.size()<= index) {
            for (int i = list.size(); (i<= index); i ++) {
                list.add(null);
            }
        }
        ConditionalPageMasterReference value = list.get(index);
        if (value == null) {
            value = new ConditionalPageMasterReference();
            list.set(index, value);
        }
        return value;
    }

    public ConditionalPageMasterReference withNewConditionalPageMasterReference() {
        ConditionalPageMasterReference value = new ConditionalPageMasterReference();
        this.getConditionalPageMasterReference().add(value);
        return value;
    }
